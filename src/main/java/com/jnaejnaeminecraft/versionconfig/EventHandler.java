...
//            }
    ...
    // Experience Drop Event
    @SubscribeEvent(priority = EventPriority.HIGHEST, receiveCanceled = true)
    public static void onEvent(LivingExperienceDropEvent event)
    {
    	if (!ModConfig.allowExperience)
    	{
    		event.setCanceled(true);
    		System.out.println("Cancelling XP"); // Disable Spawning
    	}
    }
    ...
    public static void onEvent(EntityJoinWorldEvent event)
    {
    	...
    	// Zombie Pigman
    	if (theEntity instanceof EntityPigZombie)
    	{
    		if (ModConfig.allowSpawnPigZombie)
    		{
    			if (((EntityPigZombie)theEntity).isChild() && (!ModConfig.allowBabyPigZombie))
        		{
    				((EntityPigZombie) theEntity).setChild(false); // Set All Child To Adult
        		}
    		}
    		else
    		{
        		event.setCanceled(true);
        		System.out.println("Cancelling Spawn"); // Disable Spawning
    		}
    	}
    	
    	// Zombie
    	else if (theEntity instanceof EntityZombie)
    	{
			if (((EntityZombie)theEntity).isChild() && (!ModConfig.allowBabyZombie))
    		{
				((EntityZombie) theEntity).setChild(false); // Set All Child To Adult
    		}
    	}
    	
    	// XP Orb
    	if ((theEntity instanceof EntityXPOrb)  && (!ModConfig.allowExperience))
    	{
    		event.setCanceled(true);
    	...
    	// Enderman
    	if ((theEntity instanceof EntityEnderman) && (!ModConfig.allowSpawnEnderman))
    	{
        		event.setCanceled(true);
        		System.out.println("Cancelling Spawn");
    	}
    	...
    	// Horse
    	if ((theEntity instanceof EntityHorse) && (!ModConfig.allowSpawnHorse))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Zombie Villager
    	else if (theEntity instanceof EntityZombieVillager)
    	{
    		if (ModConfig.allowSpawnZombieVillager)
    		{
    			if (((EntityZombieVillager)theEntity).isChild() && (!ModConfig.allowBabyZombieVillager))
        		{
    				((EntityZombieVillager) theEntity).setChild(false); // Set All Child To Adult
        		}
    		}
    		else
    		{
    	...
    	// Endermite
    	if ((theEntity instanceof EntityEndermite) && (!ModConfig.allowSpawnEndermite))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Guardian
    	if (theEntity instanceof EntityGuardian)
    	{
    		if (theEntity instanceof EntityElderGuardian)
        	{
    			if (!ModConfig.allowSpawnElderGuardian)
    			{
    				event.setCanceled(true);
    				System.out.println("Cancelling Spawn");
    			}
        	}
    		else if (!ModConfig.allowSpawnGuardian)
        	{
            	event.setCanceled(true);
            	System.out.println("Cancelling Spawn");
        	}
    	...
    	// Rabbit
    	if ((theEntity instanceof EntityRabbit) && (!ModConfig.allowSpawnRabbit))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Shulker
    	if ((theEntity instanceof EntityShulker) && (!ModConfig.allowSpawnShulker))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Stray
    	if ((theEntity instanceof EntityStray) && (!ModConfig.allowSpawnStray))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Husk
    	else if (theEntity instanceof EntityHusk)
    	{
    		if (ModConfig.allowSpawnHusk)
    		{
    			if (((EntityHusk)theEntity).isChild() && (!ModConfig.allowBabyHusk))
        		{
    				((EntityHusk) theEntity).setChild(false); // Set All Child To Adult
        		}
    		}
    		else
    		{
        		event.setCanceled(true); // Disable Spawning
        		System.out.println("Cancelling Spawn");
    		}
    	}
    	
    	// PolarBear
    	if ((theEntity instanceof EntityPolarBear) && (!ModConfig.allowSpawnPolarBear))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Vindicator
    	if ((theEntity instanceof EntityVindicator) && (!ModConfig.allowSpawnVindicator))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Evoker
    	if ((theEntity instanceof EntityEvoker) && (!ModConfig.allowSpawnEvoker))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Vex
    	if ((theEntity instanceof EntityVex) && (!ModConfig.allowSpawnVex))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Llama
    	if ((theEntity instanceof EntityLlama) && (!ModConfig.allowSpawnLlama))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
    	...
    	// Parrot
    	if ((theEntity instanceof EntityParrot) && (!ModConfig.allowSpawnParrot))
    	{
        	event.setCanceled(true);
        	System.out.println("Cancelling Spawn");
    	}
