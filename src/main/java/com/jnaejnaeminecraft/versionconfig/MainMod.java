...
import com.jnaejnaeminecraft.versionconfig.client.gui.GuiHandler;
import com.jnaejnaeminecraft.versionconfig.init.ModAdvancements;
import com.jnaejnaeminecraft.versionconfig.init.ModBiomes;
import com.jnaejnaeminecraft.versionconfig.init.ModBlocks;
import com.jnaejnaeminecraft.versionconfig.init.ModConfig;
import com.jnaejnaeminecraft.versionconfig.init.ModFluids;
import com.jnaejnaeminecraft.versionconfig.init.ModItems;
import com.jnaejnaeminecraft.versionconfig.init.ModNetworking;
import com.jnaejnaeminecraft.versionconfig.init.ModProfessions;
import com.jnaejnaeminecraft.versionconfig.init.ModTileEntities;
import com.jnaejnaeminecraft.versionconfig.init.ModTriggers;
import com.jnaejnaeminecraft.versionconfig.init.ModWorldGen;
import com.jnaejnaeminecraft.versionconfig.proxy.IProxy;
import com.jnaejnaeminecraft.versionconfig.utilities.Utilities;
import com.jnaejnaeminecraft.versionconfig.worldgen.structures.villages.MapGenVillageCloud;
import com.jnaejnaeminecraft.versionconfig.worldgen.structures.villages.VillageHouseCloud;
...
@Mod(   modid = MainMod.MODID,
        ...
        guiFactory = "com.jnaejnaeminecraft." + MainMod.MODID + ".client.gui.GuiFactory",
        acceptedMinecraftVersions = "[1.12]",
        updateJSON = "https://raw.githubusercontent.com/jnaejnae/VersionConfig-1.12/master/src/main/resources/versionChecker.json"
        )
public class MainMod
{
    public static final String MODID = "versionconfig";
    public static final String MODNAME = "Version Configurator";
    ...
    @SidedProxy(clientSide = "com.jnaejnaeminecraft.versionconfig.proxy.ClientProxy",
            serverSide = "com.jnaejnaeminecraft.versionconfig.proxy.ServerProxy")
