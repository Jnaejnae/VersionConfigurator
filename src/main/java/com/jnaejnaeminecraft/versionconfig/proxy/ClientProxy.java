...
package com.jnaejnaeminecraft.versionconfig.proxy;
...
import com.jnaejnaeminecraft.versionconfig.blocks.BlockLeavesCloud;
import com.jnaejnaeminecraft.versionconfig.client.localization.ModLocale;
import com.jnaejnaeminecraft.versionconfig.client.renderers.ModRenderItem;
import com.jnaejnaeminecraft.versionconfig.client.renderers.RenderFactories;
import com.jnaejnaeminecraft.versionconfig.init.ModBlockColors;
import com.jnaejnaeminecraft.versionconfig.init.ModKeyBindings;
import com.jnaejnaeminecraft.versionconfig.init.ModMaterials;
import com.jnaejnaeminecraft.versionconfig.init.ModNetworking;
import com.jnaejnaeminecraft.versionconfig.init.ModWorldGen;
import com.jnaejnaeminecraft.versionconfig.items.IExtendedReach;
import com.jnaejnaeminecraft.versionconfig.networking.MessageExtendedReachAttack;
...
//    public static Field locale = ReflectionHelper.findField(LanguageManager.class, "CURRENT_LOCALE", "CURRENT_LOCALE");
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#preInit(net.minecraftforge.fml.common.event.FMLPreInitializationEvent)
     */
    @Override
...
//        }
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#init(net.minecraftforge.fml.common.event.FMLInitializationEvent)
     */
...
//        
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#postInit(net.minecraftforge.fml.common.event.FMLPostInitializationEvent)
     */
    @Override
...
//        Minecraft.getMinecraft().refreshResources();
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#getPlayerEntityFromContext(net.minecraftforge.fml.common.network.simpleimpl.MessageContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#handleMaterialAcceleration(net.minecraft.entity.Entity, net.minecraft.block.material.Material)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#serverStarting(net.minecraftforge.fml.common.event.FMLServerStartingEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jnaejnaeminecraft.versionconfig.proxy.IProxy#setGraphicsLevel(com.jnaejnaeminecraft.versionconfig.blocks.BlockLeavesCloud, boolean)
     */
    @Override
